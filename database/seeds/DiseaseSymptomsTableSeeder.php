...
class DiseaseSymptomsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DiseaseSymptom::create([ 'disease_id' => 6, 'symptom_id' => 16 ]);
        DiseaseSymptom::create([ 'disease_id' => 6, 'symptom_id' => 23 ]);
        DiseaseSymptom::create([ 'disease_id' => 6, 'symptom_id' => 24 ]);
        DiseaseSymptom::create([ 'disease_id' => 6, 'symptom_id' => 30 ]);
        DiseaseSymptom::create([ 'disease_id' => 6, 'symptom_id' => 32 ]);

        DiseaseSymptom::create([ 'disease_id' => 7, 'symptom_id' => 7 ]);
        DiseaseSymptom::create([ 'disease_id' => 7, 'symptom_id' => 39 ]);
        DiseaseSymptom::create([ 'disease_id' => 7, 'symptom_id' => 17 ]);
        DiseaseSymptom::create([ 'disease_id' => 7, 'symptom_id' => 13 ]);
        DiseaseSymptom::create([ 'disease_id' => 7, 'symptom_id' => 32 ]);

        DiseaseSymptom::create([ 'disease_id' => 8, 'symptom_id' => 11 ]);
        ...
        DiseaseSymptom::create([ 'disease_id' => 9, 'symptom_id' => 26 ]);
